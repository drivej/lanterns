...
const os = () => {
  const o = Pe(null), { width: t, height: e } = Sn({ ref: o }), [i, r] = fr(null);
  return Fe(() => {
    i && i.setSize(t, e);
  }, [t, e]), Fe(() => {
    if (o.current)
      return r(is(o.current)), () => {
        r(null), rs();
      };
  }, []), /* @__PURE__ */ gn("div", { ref: o, style: { width: 500, height: 500 }, children: "Component" });
};
export {
  os as MyComponent
};
