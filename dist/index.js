...
import { useState as fr, useRef as Pe, useEffect as Fe, useCallback as un } from "react";
...
function kn(o) {
  const { ref: t, box: e = "content-box" } = o, [{ width: i, height: r }, n] = fr(Wi), a = An(), s = Pe({ ...Wi }), h = Pe(void 0);
  return h.current = o.onResize, Fe(() => {
    if (!t.current || typeof window > "u" || !("ResizeObserver" in window))
      return;
    const u = new ResizeObserver(([l]) => {
      const g = e === "border-box" ? "borderBoxSize" : e === "device-pixel-content-box" ? "devicePixelContentBoxSize" : "contentBoxSize", A = Ni(l, g, "inlineSize"), S = Ni(l, g, "blockSize");
...
var ct = {
  ...
  overwrite: !1,
  delay: 0
}, Ci, X, R, Ct = 1e8, E = 1 / Ct, ai = Math.PI * 2, Sn = ai / 4, dn = 0, gr = Math.sqrt, pn = Math.cos, In = Math.sin, j = function(t) {
...
}, $ = Array.isArray, Cn = /random\([^)]+\)/g, Jn = /,\s*/g, qi = /(?:-?\.?\d|\.)+/gi, kr = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, ee = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, je = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, cr = /[+-]=-?[.\d]+/, wn = /[^,'"\[\]\s]+/gi, mn = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, N, yt, si, mi, St = {}, He = {}, Sr, dr = function(t) {
  return (He = se(t, St)) && ht;
}, yi = function(t, e) {
  return console.warn("Invalid property", t, "set to", e, "Missing plugin? gsap.registerPlugin()");
}, Ie = function(t, e) {
  return !e && console.warn(t);
}, pr = function(t, e) {
  return t && (St[t] = e) && He && (He[t] = e) || St;
}, Ce = function() {
  return 0;
}, yn = {
  suppressEvents: !0,
  ...
  suppressEvents: !0
}, Qi = {}, Et = [], oi = {}, Ir, ut = {}, Xe = {}, Yi = 30, Oe = [], Bi = "", Di = function(t) {
  var e = t[0], i, r;
  ...
  return (i = t[e]) && M(i) ? t[e]() : Ji(i) && t.getAttribute && t.getAttribute(e) || i;
}, at = function(t, e) {
  ...
  for (oi = {}, Et.length = 0, i = 0; i < t; i++)
    r = e[i], r && r._lazy && (r.render(r._lazy[0], r._lazy[1], !0)._lazy = 0);
}, vi = function(t) {
  return !!(t._initted || t._startAt || t.add);
}, Jr = function(t, e, i, r) {
  Et.length && !X && Te(), t.render(e, i, !!(X && e < 0 && vi(t))), Et.length && !X && Te();
}, wr = function(t) {
  var e = parseFloat(t);
  ...
  var e = t.parent || N, i = t.keyframes ? Dn($(t.keyframes)) : dt;
  if (nt(t.inherit))
    for (; e; )
  ...
  return e.parent && Lt(e), e._start = W((Kt(i) ? i : i || t !== N ? It(t, i, e) : t._time) + e._delay), e._end = W(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)), yr(t, e, "_first", "_last", t._sort ? "_start" : 0), li(e) || (t._recent = e), r || Qr(t, e), t._ts < 0 && Ye(t, t._tTime), t;
}, Br = function(t, e) {
  return (St.ScrollTrigger || yi("scrollTrigger", e)) && St.ScrollTrigger.create(e, t);
}, Dr = function(t, e, i, r, n) {
  if (Oi(t, e, n), !t._initted)
    return 1;
  if (!i && t._pt && !X && (t._dur && t.vars.lazy !== !1 || !t._dur && t.vars.lazy) && Ir !== gt.frame)
  ...
  var n = t.ratio, a = e < 0 || !e && (!t._start && Kn(t) && !(!t._initted && li(t)) || (t._ts < 0 || t._dp._ts < 0) && !li(t)) ? 0 : 1, s = t._rDelay, h = 0, u, l, g;
  if (s && t._repeat && (h = Be(0, t._tDur, e), l = oe(h, s), t._yoyo && l & 1 && (a = 1 - a), l !== oe(t._tTime, s) && (n = 1 - a, t.vars.repeatRefresh && t._initted && t.invalidate())), a !== n || X || r || t._zTime === E || !e && t._zTime) {
    ...
    for (g = t._zTime, t._zTime = e || (i ? E : 0), i || (i = e && !g), t.ratio = a, t._from && (a = 1 - a), t._time = 0, t._tTime = h, u = t._pt; u; )
      u.r(a, u.d), u = u._next;
    e < 0 && hi(t, e, i, !0), t._onUpdate && !i && At(t, "onUpdate"), h && t._repeat && !i && t.parent && At(t, "onRepeat"), (e >= t._tDur || e < 0) && t.ratio === a && (a && Lt(t, 1), !i && !X && (At(t, a ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
  ...
  var r = t.labels, n = t._recent || Fn, a = t.duration() >= Ct ? n.endTime(!1) : t._dur, s, h, u;
  ...
  if (r && (a.duration = e[1]), a.parent = i, t) {
    for (s = a, h = i; h && !("immediateRender" in s); )
      s = h.vars.defaults || {}, h = nt(h.vars.inherit) && h.parent;
    a.immediateRender = nt(s.immediateRender), t < 2 ? a.runBackwards = 1 : a.startAt = e[n - 1];
  }
  ...
  return R && !e && R.selector ? R.selector(t) : j(t) && !i && (si || !le()) ? fi.call((e || mi).querySelectorAll(t), 0) : $(t) ? Tn(t, i) : vr(t) ? fi.call(t, 0) : t ? [t] : [];
}, ui = function(t) {
  return t = Jt(t)[0] || Ie("Invalid scope") || {}, function(e) {
    var i = t.current || t.nativeElement || t;
    return Jt(e, i.querySelectorAll ? i : i === t ? Ie("Invalid scope") || mi.createElement("div") : t);
  };
}, xr = function(t) {
  ...
  return j(r) ? l = g = {
    ...
    if (!I) {
      if (y = e.grid === "auto" ? 0 : (e.grid || [1, Ct])[1], !y) {
        for (m = -Ct; m < (m = p[y++].getBoundingClientRect().left) && y < k; )
          ;
        y < k && y--;
      }
      for (I = a[k] = [], w = h ? Math.min(y, k) * l - 0.5 : r % y, f = y === Ct ? 0 : h ? k * g / y - 0.5 : r / y | 0, m = 0, Q = Ct, J = 0; J < k; J++)
        C = J % y - w, d = f - (J / y | 0), I[J] = c = u ? Math.abs(u === "y" ? d : C) : gr(C * C + d * d), c > m && (m = c), c < Q && (Q = c);
      r === "random" && xr(I), I.max = m - Q, I.min = Q, I.v = k = (parseFloat(e.amount) || parseFloat(e.each) * (y > k ? k - 1 : u ? u === "y" ? k / y : y : Math.max(y, k / y)) || 0) * (r === "edges" ? -1 : 1), I.b = k < 0 ? n - k : n, I.u = _(e.amount || e.each) || 0, i = i && k < 0 ? Zn(i) : i;
    }
  ...
  var i = $(t), r, n;
  return !i && Dt(t) && (r = i = t.radius || Ct, t.values ? (t = Jt(t.values), (n = !Kt(t[0])) && (r *= r)) : t = gi(t.increment)), Gt(e, i ? M(t) ? function(a) {
    return n = t(a), Math.abs(n - a) <= r ? n : a;
  } : function(a) {
    for (var s = parseFloat(n ? a.x : a), h = parseFloat(n ? a.y : 0), u = Ct, l = 0, g = t.length, A, S; g--; )
  ...
  return t.replace(Cn, function(e) {
    var i = e.indexOf("[") + 1, r = e.substring(i || 7, i ? e.indexOf("]") : e.length - 1).split(Jn);
  ...
  return Lt(t), t.scrollTrigger && t.scrollTrigger.kill(!!X), t.progress() < 1 && At(t, "onInterrupt"), t;
}, ie, Hr = [], Tr = function(t) {
  if (t)
    if (t = !t.name && t.default || t, wi() || t.headless) {
      ...
      if (le(), t !== r) {
        if (ut[e])
          return;
        dt(r, dt(Ee(t, n), a)), se(r.prototype, se(n, Ee(t, a))), ut[r.prop = e] = r, t.targetTest && (Oe.push(r), Qi[e] = 1), e = (e === "css" ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin";
      }
      pr(e, r), t.register && t.register(ht, r, st);
    } else
      Hr.push(t);
}, T = 255, Ae = {
  aqua: [0, T, T],
  ...
  if (n = n.map(function(A) {
    return (A = Er(A, e, 1)) && a + (e ? A[0] + "," + A[1] + "%," + A[2] + "%," + A[3] : A.join(",")) + ")";
...
})(), Vn = /hsl[a]?\(/, Lr = function(t) {
  var e = t.join(" "), i;
  if (Rt.lastIndex = 0, Rt.test(e))
    return i = Vn.test(e), t[1] = ji(t[1], i), t[0] = ji(t[0], i, Rr(t[1])), !0;
}, we, gt = (function() {
  ...
  return g = {
    ...
    wake: function() {
      Sr && (!si && wi() && (yt = si = window, mi = yt.document || {}, St.gsap = ht, (yt.gsapVersions || (yt.gsapVersions = [])).push(ht.version), dr(He || yt.GreenSockGlobals || !yt.gsap && yt || {}), Hr.forEach(Tr)), l = typeof requestAnimationFrame < "u" && requestAnimationFrame, h && g.sleep(), u = l || function(I) {
  ...
  return !we && gt.wake();
}, K = {}, qn = /^[\d.\-M][\d.\-,\s]/, Yn = /["']/g, bn = function(t) {
  for (var e = {}, i = t.substr(1, t.length - 3).split(":"), r = i[0], n = 1, a = i.length, s, h, u; n < a; n++)
    h = i[n], s = n !== a - 1 ? h.lastIndexOf(",") : h.length, u = h.substr(0, s), e[r] = isNaN(u) ? u.replace(Yn, "").trim() : +u, r = h.substr(s + 1).trim();
  return e;
}, Mn = function(t) {
  ...
  return i && e.length > 1 && i.config ? i.config.apply(null, ~t.indexOf("{") ? [bn(e[1])] : Mn(t).split(",").map(wr)) : K._CE && qn.test(t) ? K._CE("", t) : i;
}, Zn = function(t) {
  return function(e) {
    return 1 - t(1 - e);
  };
  ...
  return at(t, function(s) {
    K[s] = St[s] = n, K[a = s.toLowerCase()] = i;
    for (var h in n)
  ...
  var r = e >= 1 ? e : 1, n = (i || (t ? 0.3 : 0.45)) / (e < 1 ? e : 1), a = n / ai * (Math.asin(1 / r) || 0), s = function(l) {
    return l === 1 ? 1 : r * Math.pow(2, -10 * l) * In((l - a) * n) + 1;
  }, h = t === "out" ? s : t === "in" ? function(u) {
    return 1 - s(1 - u);
  } : Wr(s);
  return n = ai / n, h.config = function(u, l) {
    return o(t, u, l);
  }, h;
}, ti = function o(t, e) {
  e === void 0 && (e = 1.70158);
...
at("Linear,Quad,Cubic,Quart,Quint,Strong", function(o, t) {
  var e = t < 5 ? t + 1 : t;
...
pe.ease = K["quad.out"];
at("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", function(o) {
  return Bi += o + "," + o + "Params,";
});
var Nr = function(t, e) {
  this.id = dn++, t._gsap = this, this.target = t, this.harness = e, this.get = e ? e.get : Cr, this.set = e ? e.getSetter : Ui;
}, me = /* @__PURE__ */ (function() {
  function o(e) {
    this.vars = e, this._delay = +e.delay || 0, (this._repeat = e.repeat === 1 / 0 ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0, this._yoyo = !!e.yoyo || !!e.yoyoEase), this._ts = 1, he(this, +e.duration, 1, 1), this.data = e.data, R && (this._ctx = R, R.data.push(this)), we || gt.wake();
  }
  var t = o.prototype;
  return t.delay = function(i) {
    ...
    return (this._tTime !== i || !this._dur && !r || this._initted && Math.abs(this._zTime) === E || !this._initted && this._dur && i || !i && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = i), Jr(this, i, r)), this;
  }, t.time = function(i, r) {
    ...
    return this._rts = +i || 0, this._ts = this._ps || i === -E ? 0 : this._rts, this.totalTime(Be(-Math.abs(this._delay), this.totalDuration(), n), r !== !1), qe(this), xn(this);
  }, t.paused = function(i) {
    ...
    return this.totalTime(It(this, i), nt(r));
  }, t.restart = function(i, r) {
    return this.play().totalTime(i ? -this._delay : 0, nt(r)), this._dur || (this._zTime = -E), this;
  }, t.play = function(i, r) {
...
var rt = /* @__PURE__ */ (function(o) {
  ...
  function t(i, r) {
    var n;
    return i === void 0 && (i = {}), n = o.call(this, i) || this, n.labels = {}, n.smoothChildTiming = !!i.smoothChildTiming, n.autoRemoveChildren = !!i.autoRemoveChildren, n._sort = nt(i.sortChildren), N && Qt(i.parent || N, xt(n), r), i.reversed && n.reverse(), i.paused && n.paused(!0), i.scrollTrigger && Br(xt(n), i.scrollTrigger), n;
  }
  var e = t.prototype;
  return e.to = function(r, n, a) {
    ...
    return n.duration = 0, n.parent = this, ce(n).repeatDelay || (n.repeat = 0), n.immediateRender = !!n.immediateRender, new Z(r, n, It(this, a), 1), this;
  }, e.call = function(r, n, a) {
    return Qt(this, Z.delayedCall(0, r, n), a);
  }, e.staggerTo = function(r, n, a, s, h, u, l) {
    return a.duration = n, a.stagger = a.stagger || s, a.onComplete = u, a.onCompleteParams = l, a.parent = this, new Z(r, a, It(this, h)), this;
  }, e.staggerFrom = function(r, n, a, s, h, u, l) {
    return a.runBackwards = 1, ce(a).immediateRender = nt(a.immediateRender), this.staggerTo(r, n, a, s, h, u, l);
  }, e.staggerFromTo = function(r, n, a, s, h, u, l, g) {
    return s.startAt = a, ce(s).immediateRender = nt(s.immediateRender), this.staggerTo(r, n, s, h, u, l, g);
    ...
    if (this !== N && l > h && r >= 0 && (l = h), l !== this._tTime || a || g) {
      if (s !== this._time && u && (l += this._time - s, r += this._time - s), A = l, d = this._start, C = this._ts, w = !C, g && (u || (s = this._zTime), (r || !n) && (this._zTime = r)), this._repeat) {
        ...
        if (A = W(l % I), l === h ? (k = this._repeat, A = u) : (c = W(l / I), k = ~~c, k && k === c && (A = u, k--), A > u && (A = u)), c = oe(this._tTime, I), !s && this._tTime && c !== k && this._tTime - c * I - this._dur <= 0 && (c = k), J && k & 1 && (A = u - A, m = 1), k !== c && !this._lock) {
          ...
          if (k < c && (Q = !Q), s = Q ? 0 : l % u ? u : l, this._lock = 1, this.render(s || (m ? 0 : W(k * I)), n, !u)._lock = 0, this._tTime = l, !n && this.parent && At(this, "onRepeat"), this.vars.repeatRefresh && !m && (this.invalidate()._lock = 1, c = k), s && s !== this._time || w !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (f = Pn(this, W(s), W(A)), f && (l -= A - (A = f._start))), this._tTime = l, this._time = A, this._act = !!C, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, s = 0), !s && l && u && !n && !c && (At(this, "onStart"), this._tTime !== l))
        return this;
      if (A >= s && r >= 0)
        for (S = this._first; S; ) {
        ...
        for (var B = r < 0 ? r : A; S; ) {
          if (p = S._prev, (S._act || B <= S._end) && S._ts && f !== S) {
            if (S.parent !== this)
              return this.render(r, n, a);
            if (S.render(S._ts > 0 ? (B - S._start) * S._ts : (S._dirty ? S.totalDuration() : S._tDur) + (B - S._start) * S._ts, n, a || X && vi(S)), A !== this._time || !this._ts && !w) {
      ...
      this._onUpdate && !n && At(this, "onUpdate", !0), (l === h && this._tTime >= this.totalDuration() || !l && s) && (d === this._start || Math.abs(C) !== Math.abs(this._ts)) && (this._lock || ((r || !u) && (l === h && this._ts > 0 || !l && this._ts < 0) && Lt(this, 1), !n && !(r < 0 && !s) && (l || s || !h) && (At(this, l === h && r >= 0 ? "onComplete" : "onReverseComplete", !0), this._prom && !(l < h && this.timeScale() > 0) && this._prom())));
    }
    return this;
  }, e.add = function(r, n) {
    var a = this;
    if (Kt(n) || (n = It(this, n, r)), !(r instanceof me)) {
      if ($(r))
    ...
    return arguments.length ? (this._forcing = 1, !this._dp && this._ts && (this._start = W(gt.time - (this._ts > 0 ? r / this._ts : (this.totalDuration() - r) / -this._ts))), o.prototype.totalTime.call(this, r, n), this._forcing = 0, this) : this._tTime;
    ...
    for (var a = [], s = Jt(r), h = this._first, u = Kt(n), l; h; )
      h instanceof Z ? Bn(h._targets, s) && (u ? (!Ft || h._initted && h._ts) && h.globalTime(0) <= n && h.globalTime(h.totalDuration()) > n : !n || h.isActive()) && a.push(h) : (l = h.getTweensOf(s, n)).length && a.push.apply(a, l), h = h._next;
    return a;
  }, e.tweenTo = function(r, n) {
    n = n || {};
    var a = this, s = It(a, r), h = n, u = h.startAt, l = h.onStart, g = h.onStartParams, A = h.immediateRender, S, p = Z.to(a, dt({
      ease: n.ease || "none",
      lazy: !1,
      immediateRender: !1,
      time: s,
    ...
    var n = 0, a = this, s = a._last, h = Ct, u, l, g;
    if (arguments.length)
    ...
    if (N._ts && (Jr(N, Re(r, N)), Ir = gt.frame), gt.frame >= Yi) {
      Yi += ct.autoSleep || 120;
      var n = N._first;
      if ((!n || !n._ts) && ct.autoSleep && gt._listeners.length < 2) {
        for (; n && !n._ts; )
          n = n._next;
        n || gt.sleep();
      }
...
var jn = function(t, e, i, r, n, a, s) {
  var h = new st(this._pt, t, e, 0, 1, Mr, null, n), u = 0, l = 0, g, A, S, p, k, I, w, f;
  ...
  return h.c = u < r.length ? r.substring(u, r.length) : "", h.fp = s, (cr.test(r) || w) && (h.e = 0), this._pt = h, h;
}, xi = function(t, e, i, r, n, a, s, h, u, l) {
  M(r) && (r = r(n || 0, t, a));
  var g = t[e], A = i !== "get" ? i : M(g) ? u ? t[e.indexOf("set") || !M(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](u) : t[e]() : g, S = M(g) ? u ? ea : Yr : Ki, p;
  if (j(r) && (~r.indexOf("random(") && (r = Je(r)), r.charAt(1) === "=" && (p = re(A, r) + (_(A) || 0), (p || p === 0) && (r = p))), !l || A !== r || Ai)
    return !isNaN(A * r) && r !== "" ? (p = new st(this._pt, t, e, +A || 0, r - (A || 0), typeof g == "boolean" ? ra : br, 0, S), u && (p.fp = u), s && p.modifier(s, this, t), this._pt = p) : (!g && !(e in t) && yi(e, r), jn.call(this, t, e, A, r, S, h || ct.stringFilter, u));
}, Xn = function(t, e, i, r, n) {
  if (M(t) && (t = de(t, n, e, i, r)), !Dt(t) || t.style && t.nodeType || $(t) || Ar(t))
    return j(t) ? de(t, n, e, i, r) : t;
  var a = {}, s;
  for (s in t)
    a[s] = de(t[s], n, e, i, r);
  return a;
}, Gr = function(t, e, i, r, n, a) {
  var s, h, u, l;
  if (ut[t] && (s = new ut[t]()).init(n, s.rawVars ? e[t] : Xn(e[t], r, n, a, i), i, r, a) !== !1 && (i._pt = h = new st(i._pt, n, t, 0, 1, s.render, s, 0, s.priority), i !== ie))
    for (u = i._ptLookup[i._targets.indexOf(n)], l = s._props.length; l--; )
      u[s._props[l]] = h;
  return s;
}, Ft, Ai, Oi = function o(t, e, i) {
  var r = t.vars, n = r.ease, a = r.startAt, s = r.immediateRender, h = r.lazy, u = r.onUpdate, l = r.runBackwards, g = r.yoyoEase, A = r.keyframes, S = r.autoRevert, p = t._dur, k = t._startAt, I = t._targets, w = t.parent, f = w && w.data === "nested" ? w.vars.targets : I, C = t._overwrite === "auto" && !Ci, d = t.timeline, c = r.easeReverse || g, J, m, Q, y, B, x, v, O, P, H, U, F, V;
  if (d && (!A || !n) && (n = "none"), t._ease = jt(n, pe.ease), t._rEase = c && (jt(c) || t._ease), t._from = !d && !!r.runBackwards, t._from && (t.ratio = 1), !d || A && !r.stagger) {
    if (O = I[0] ? zt(I[0]).harness : 0, F = O && r[O.prop], J = Ee(r, Qi), k && (k._zTime < 0 && k.progress(1), e < 0 && l && s && !S ? k.render(-1, !0) : k.revert(l && p ? xe : yn), k._lazy = 0), a) {
      if (Lt(t._startAt = Z.set(I, dt({
        data: "isStart",
        overwrite: !1,
        parent: w,
        immediateRender: !0,
    ...
    for (t._pt = t._ptCache = 0, h = p && nt(h) || h && !p, m = 0; m < I.length; m++) {
      if (B = I[m], v = B._gsap || Di(I)[m]._gsap, t._ptLookup[m] = H = {}, oi[v.id] && Et.length && Te(), U = f === I ? m : f.indexOf(B), O && (P = new O()).init(B, F || J, t, U, f) !== !1 && (t._pt = y = new st(t._pt, B, P.name, 0, 1, P.render, P, 0, P.priority), P._props.forEach(function(et) {
        H[et] = y;
      }), P.priority && (x = 1)), !O || F)
        for (Q in J)
          ut[Q] && (P = Gr(Q, J, t, U, B, f)) ? P.priority && (x = 1) : H[Q] = y = xi.call(t, B, Q, "get", J[Q], U, f, 0, r.stringFilter);
      t._op && t._op[m] && t.kill(B, t._op[m]), C && t._pt && (Ft = t, N.killTweensOf(B, H, t.globalTime(e)), V = !t.parent, Ft = 0), t._pt && h && (oi[v.id] = 1);
    }
    x && zr(t), t._onInit && t._onInit(t);
  }
  t._onUpdate = u, t._initted = (!t._op || t._pt) && !V, A && e <= 0 && d.render(Ct, !0, !0);
    ...
    for (u = t._ptCache[e] = [], A = t._ptLookup, S = t._targets.length; S--; ) {
      if (l = A[S][e], l && l.d && l.d._pt)
        for (l = l.d._pt; l && l.p !== e && l.fp !== e; )
          l = l._next;
      if (!l)
        return Ai = 1, t.vars[e] = "+=0", Oi(t, s), Ai = 0, h ? Ie(e + " not eligible for reset. Try splitting into individual properties") : 1;
      u.push(l);
    }
  for (S = u.length; S--; )
...
}, Vr = Bi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert", qr = {};
at(Vr + ",id,stagger,delay,duration,paused,scrollTrigger", function(o) {
  return qr[o] = 1;
});
var Z = /* @__PURE__ */ (function(o) {
  ...
  function t(i, r, n, a) {
    ...
    var h = s.vars, u = h.duration, l = h.delay, g = h.immediateRender, A = h.stagger, S = h.overwrite, p = h.keyframes, k = h.defaults, I = h.scrollTrigger, w = r.parent || N, f = ($(i) || Ar(i) ? Kt(i[0]) : "length" in r) ? [i] : Jt(i), C, d, c, J, m, Q, y, B;
    if (s._targets = f.length ? Di(f) : Ie("GSAP target " + i + " not found. https://gsap.com", !ct.nullTargetWarn) || [], s._ptLookup = [], s._overwrite = S, p || A || ve(u) || ve(l)) {
      r = s.vars;
      ...
      if (C = s.timeline = new rt({
        ...
        if (J = f.length, y = A && Or(A), Dt(A))
          for (m in A)
            ~Vr.indexOf(m) && (B || (B = {}), B[m] = A[m]);
        for (d = 0; d < J; d++)
          c = Ee(r, qr), c.stagger = 0, x && (c.easeReverse = x), B && se(c, B), Q = f[d], c.duration = +de(u, xt(s), d, Q, f), c.delay = (+de(l, xt(s), d, Q, f) || 0) - s._delay, !A && J === 1 && c.delay && (s._delay = l = c.delay, s._start += l, c.delay = 0), C.to(Q, c, y ? y(d, Q, f) : 0), C._ease = K.none;
        C.duration() ? u = l = 0 : s.timeline = 0;
      } else if (p) {
        ce(dt(C.vars.defaults, {
          ease: "none"
        ...
        if ($(p))
          ...
          c = {};
          for (m in p)
            m === "ease" || m === "easeEach" || ta(m, p[m], c, p.easeEach);
          for (m in c)
      ...
      s.timeline = 0;
    return S === !0 && !Ci && (Ft = xt(s), N.killTweensOf(f), Ft = 0), Qt(w, xt(s), n), r.reversed && s.reverse(), r.paused && s.paused(!0), (g || !u && !p && s._start === W(w._time) && nt(g) && On(xt(s)) && w.data !== "nested") && (s._tTime = -E, s.render(Math.max(0, -l) || 0)), I && Br(xt(s), I), s;
  }
  var e = t.prototype;
  return e.render = function(r, n, a) {
    ...
    if (!u)
      ...
      if (this._from && (this.ratio = f = 1 - f), this._tTime = g, this._time = A, !this._act && this._ts && (this._act = 1, this._lazy = 0), !s && g && !n && !I && (At(this, "onStart"), this._tTime !== g))
        return this;
      for (S = this._pt; S; )
        S.r(f, S.d), S = S._next;
      C && C.render(r < 0 ? r : C._dur * C._ease(A / this._dur), n, a) || this._startAt && (this._zTime = r), this._onUpdate && !n && (l && hi(this, r, n, a), At(this, "onUpdate")), this._repeat && p !== I && this.vars.onRepeat && !n && this.parent && At(this, "onRepeat"), (g === this._tDur || !g) && this._tTime === g && (l && !this._onUpdate && hi(this, r, !0, !0), (r || !u) && (g === this._tDur && this._ts > 0 || !g && this._ts < 0) && Lt(this, 1), !n && !(l && !s) && (g || s || w) && (At(this, g === h ? "onComplete" : "onReverseComplete", !0), this._prom && !(g < h && this.timeScale() > 0) && this._prom()));
    }
    return this;
  }, e.targets = function() {
    ...
    we || gt.wake(), this._ts || this.play();
    var u = Math.min(this._dur, (this._dp._time - this._start) * this._ts), l;
    return this._initted || Oi(this, u), l = this._ease(u / this._dur), _n(this, r, n, a, s, l, u, h) ? this.resetTo(r, n, a, s, 1) : (Ye(this, 0), this.parent || yr(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, e.kill = function(r, n) {
    ...
    var s = this._targets, h = r ? Jt(r) : s, u = this._ptLookup, l = this._pt, g, A, S, p, k, I, w;
    if ((!n || n === "all") && vn(s, h))
      return n === "all" && (this._pt = 0), ge(this);
    for (g = this._op = this._op || [], n !== "all" && (j(n) && (k = {}, at(n, function(f) {
      return k[f] = 1;
    }), n = k), n = $n(s, n)), w = s.length; w--; )
      if (~h.indexOf(s[w])) {
...
at("staggerTo,staggerFrom,staggerFromTo", function(o) {
  Z[o] = function() {
    var t = new rt(), e = fi.call(arguments, 0);
...
var Ki = function(t, e, i) {
  ...
  return M(t[e]) ? Yr : Ji(t[e]) && t.setAttribute ? ia : Ki;
}, br = function(t, e) {
  ...
  function o(e, i, r, n, a, s, h, u, l) {
    this.t = i, this.s = n, this.c = a, this.p = r, this.r = s || br, this.d = h || this, this.set = u || Ki, this.pr = l || 0, this._next = e, e && (e._prev = this);
  }
  var t = o.prototype;
...
at(Bi + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse", function(o) {
  return Qi[o] = 1;
});
St.TweenMax = St.TweenLite = Z;
St.TimelineLite = St.TimelineMax = rt;
N = new rt({
  sortChildren: !1,
  defaults: pe,
...
var Xt = [], Ke = {}, oa = [], Xi = 0, ha = 0, ei = function(t) {
  ...
  return t.add = function(i, r, n) {
    ...
    var a = this, s = function() {
      ...
      return u && u !== a && u.data.push(a), n && (a.selector = ui(n)), R = a, g = r.apply(a, arguments), M(g) && a._r.push(g), R = u, a.selector = l, a.isReverted = !1, g;
    };
  ...
  return t.add = function(i, r, n) {
    ...
    var a = new Zr(0, n || this.scope), s = a.conditions = {}, h, u, l;
    R && !a.selector && (a.selector = R.selector), this.contexts.push(a), r = a.add("onMatch", r), a.queries = i;
    for (u in i)
      u === "all" ? l = 1 : (h = yt.matchMedia(i[u]), h && (Xt.indexOf(a) < 0 && Xt.push(a), (s[u] = h.matches) && (l = 1), h.addListener ? h.addListener(ki) : h.addEventListener("change", ki)));
  ...
  getProperty: function(t, e, i, r) {
    j(t) && (t = Jt(t)[0]);
    var n = zt(t || {}).get, a = i ? mr : wr;
    return i === "native" && (i = ""), t && (e ? a((ut[e] && ut[e].get || n)(t, e, i, r)) : function(s, h, u) {
      return a((ut[s] && ut[s].get || n)(t, s, h, u));
    });
  },
  quickSetter: function(t, e, i) {
    if (t = Jt(t), t.length > 1) {
      var r = t.map(function(l) {
        return ht.quickSetter(l, e, i);
      }), n = r.length;
      return function(l) {
        for (var g = n; g--; )
          r[g](l);
    ...
    t = t[0] || {};
    var a = ut[e], s = zt(t), h = s.harness && (s.harness.aliases || {})[e] || e, u = a ? function(l) {
      var g = new a();
  ...
  quickTo: function(t, e, i) {
    var r, n = ht.to(t, dt((r = {}, r[e] = "+=0.1", r.paused = !0, r.stagger = 0, r), i || {})), a = function(h, u, l) {
  ...
  defaults: function(t) {
    return t && t.ease && (t.ease = jt(t.ease, pe.ease)), bi(pe, t || {});
  },
  config: function(t) {
    return bi(ct, t || {});
  },
  registerEffect: function(t) {
    ...
    (r || "").split(",").forEach(function(s) {
      return s && !ut[s] && !St[s] && Ie(e + " effect requires " + s + " plugin.");
    }), Xe[e] = function(s, h, u) {
      return i(Jt(s), dt(h || {}, n), u);
...
at("to,from,fromTo,delayedCall,set,killTweensOf", function(o) {
  return Le[o] = Z[o];
});
gt.add(rt.updateRoot);
ie = Le.to({}, {
  duration: 0
});
var fa = function(t, e) {
...
Z.version = rt.version = ht.version = "3.15.0";
Sr = 1;
wi() && le();
K.Power0;
var ga = K.Power1;
...
var _i, Ht, ne, Fi, Mt, $i, Hi, Aa = function() {
  return typeof window < "u";
}, Ut = {}, bt = 180 / Math.PI, ae = Math.PI / 180, te = Math.atan2, tr = 1e8, Ti = /([A-Z])/g, ka = /(left|right|width|margin|padding|x)/i, ca = /[\s,\(]\S/, Bt = {
  ...
  if (t in Ut && n) {
    ...
    if (this.props.indexOf(G) >= 0)
      return;
    a.svg && (this.svgo = r.getAttribute("data-svg-origin"), this.props.push(ot, e, "")), t = G;
  }
  ...
  for (n = 0; n < t.length; n += 3)
    t[n + 1] ? t[n + 1] === 2 ? e[t[n]](t[n + 2]) : e[t[n]] = t[n + 2] : t[n + 2] ? i[t[n]] = t[n + 2] : i.removeProperty(t[n].substr(0, 2) === "--" ? t[n] : t[n].replace(Ti, "-$1").toLowerCase());
  if (this.tfm) {
    for (a in this.tfm)
      r[a] = this.tfm[a];
    r.svg && (r.renderTransform(), e.setAttribute("data-svg-origin", this.svgo || "")), n = Hi(), (!n || !n.isStart) && !i[G] && (_r(i), r.zOrigin && i[ot] && (i[ot] += " " + r.zOrigin + "px", r.zOrigin = 0, r.renderTransform()), r.uncache = 1);
  }
}, $r = function(t, e) {
  var i = {
    target: t,
  ...
  return t._gsap || ht.core.getCache(t), e && t.style && t.nodeType && e.split(",").forEach(function(r) {
    return i.save(r);
  }), i;
}, tn, Si = function(t, e) {
  ...
  return r[e] || r.getPropertyValue(e.replace(Ti, "-$1").toLowerCase()) || r.getPropertyValue(e) || !i && o(t, fe(e) || e, 1) || "";
}, er = "O,Moz,ms,Ms,Webkit".split(","), fe = function(t, e, i) {
  ...
  Aa() && window.document && (_i = window, Ht = _i.document, ne = Ht.documentElement, Mt = Si("div") || {
    style: {}
  }, Si("div"), G = fe(G), ot = G + "Origin", Mt.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", tn = !!fe("perspective"), Hi = ht.core.reverting, Fi = 1);
}, ir = function(t) {
  ...
  if (e) {
    var i = t.style, r;
    e in Ut && e !== ot && (e = G), i.removeProperty ? (r = e.substr(0, 2), (r === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e), i.removeProperty(r === "--" ? e : e.replace(Ti, "-$1").toLowerCase())) : i.removeAttribute(e);
  }
}, Tt = function(t, e, i, r, n, a) {
  var s = new st(t._pt, e, i, 0, 1, a ? Xr : jr);
  ...
  var n = parseFloat(i) || 0, a = (i + "").trim().substr((n + "").length) || "px", s = Mt.style, h = ka.test(e), u = t.tagName.toLowerCase() === "svg", l = (u ? "client" : "offset") + (h ? "Width" : "Height"), g = 100, A = r === "px", S = r === "%", p, k, I, w;
  if (r === a || !n || nr[r] || nr[a])
    return n;
  if (a !== "px" && !A && (n = o(t, e, i, "px")), w = t.getCTM && rn(t), (S || a === "%") && (Ut[e] || ~e.indexOf("adius")))
    return p = w ? t.getBBox()[h ? "width" : "height"] : t[l], z(S ? n / p * g : n / 100 * p);
  if (s[h ? "width" : "height"] = g + (A ? a : r), k = r !== "rem" && ~e.indexOf("adius") || r === "em" && t.appendChild && !u ? t : t.parentNode, w && (k = (t.ownerSVGElement || {}).parentNode), (!k || k === Ht || !k.appendChild) && (k = Ht.body), I = k._gsap, I && S && I.width && h && I.time === gt.time && !I.uncache)
    return z(n / I.width * g);
  if (S && (e === "height" || e === "width")) {
    var f = t.style[e];
    t.style[e] = g + r, p = t[l], f ? t.style[e] = f : Wt(t, e);
  } else
    (S || a === "%") && !va[kt(k, "display")] && (s.position = kt(t, "position")), k === t && (s.position = "static"), k.appendChild(Mt), p = Mt[l], k.removeChild(Mt), s.position = "absolute";
  return h && S && (I = zt(k), I.time = gt.time, I.width = k[l]), z(A ? p * n / g : p && n ? g / p * n : 0);
}, Ot = function(t, e, i, r) {
  var n;
  return Fi || di(), e in Bt && e !== "transform" && (e = Bt[e], ~e.indexOf(",") && (e = e.split(",")[0])), Ut[e] && e !== "transform" ? (n = Qe(t, r), n = e !== "transformOrigin" ? n[e] : n.svg ? n.origin : Ne(kt(t, ot)) + " " + n.zOrigin + "px") : (n = t.style[e], (!n || n === "auto" || r || ~(n + "").indexOf("calc(")) && (n = We[e] && We[e](t, e, i) || kt(t, e) || Cr(t, e) || (e === "opacity" ? 1 : 0))), i && !~(n + "").trim().indexOf(" ") ? Nt(t, e, n, i) + i : n;
}, xa = function(t, e, i, r) {
  if (!i || i === "none") {
    var n = fe(e, t, 1), a = n && kt(t, n, 1);
    a && a !== i ? (e = n, i = a) : e === "borderColor" && (i = kt(t, "borderTopColor"));
  }
  var s = new st(this._pt, t.style, e, 0, 1, Mr), h = 0, u = 0, l, g, A, S, p, k, I, w, f, C, d, c;
  if (s.b = i, s.e = r, i += "", r += "", r.substring(0, 6) === "var(--" && (r = kt(t, r.substring(4, r.indexOf(")")))), r === "auto" && (k = t.style[e], t.style[e] = r, r = kt(t, e) || r, k ? t.style[e] = k : Wt(t, e)), l = [i, r], Lr(l), i = l[0], r = l[1], A = i.match(ee) || [], c = r.match(ee) || [], c.length) {
    for (; g = ee.exec(r); )
      I = g[0], f = r.substring(h, g.index), p ? p = (p + 1) % 5 : (f.substr(-5) === "rgba(" || f.substr(-5) === "hsla(") && (p = 1), I !== (k = A[u++] || "") && (S = parseFloat(k) || 0, d = k.substr((S + "").length), I.charAt(1) === "=" && (I = re(S, I) + d), w = parseFloat(I), C = I.substr((w + "").length), h = ee.lastIndex - C.length, C || (C = C || ct.units[e] || d, h === r.length && (r += C, s.e += C)), d !== C && (S = Nt(t, e, k, C) || 0), s._pt = {
        _next: s._pt,
        p: f || u === 1 ? f : ",",
        //note: SVG spec allows omission of comma/space when a negative sign is wedged between two numbers, like 2.5-5.3 instead of 2.5,-5.3 but when tweening, the negative value may switch to positive, so we insert the comma just in case.
        s: S,
  ...
  if (e.tween && e.tween._time === e.tween._dur) {
    ...
    if (n === "all" || n === !0)
      ...
      for (n = n.split(","), u = n.length; --u > -1; )
        s = n[u], Ut[s] && (h = 1, s = s === "transformOrigin" ? ot : G), Wt(i, s);
    h && (Wt(i, G), a && (a.svg && i.removeAttribute("transform"), r.scale = r.rotate = r.translate = "none", Qe(i, 1), a.uncache = 1, _r(r)));
  }
}, We = {
  clearProps: function(t, e, i, r, n) {
    if (n.data !== "isFromStart") {
      var a = t._pt = new st(t._pt, e, i, 0, 0, Ka);
  ...
  */
}, ye = [1, 0, 0, 1, 0, 0], nn = {}, an = function(t) {
  return t === "matrix(1, 0, 0, 1, 0, 0)" || t === "none" || !t;
}, sr = function(t) {
  var e = kt(t, G);
  return an(e) ? ye : e.substr(7).match(kr).map(z);
}, Ei = function(t, e) {
  var i = t._gsap || zt(t), r = t.style, n = sr(t), a, s, h, u;
  return i.svg && t.getAttribute("transform") ? (h = t.transform.baseVal.consolidate().matrix, n = [h.a, h.b, h.c, h.d, h.e, h.f], n.join(",") === "1,0,0,1,0,0" ? ye : n) : (n === ye && !t.offsetParent && t !== ne && !i.svg && (h = r.display, r.display = "block", a = t.parentNode, (!a || !t.offsetParent && !t.getBoundingClientRect().width) && (u = 1, s = t.nextElementSibling, ne.appendChild(t)), n = sr(t), h ? r.display = h : Wt(t, "display"), u && (s ? a.insertBefore(t, s) : a ? a.appendChild(t) : ne.removeChild(t))), e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n);
}, pi = function(t, e, i, r, n, a) {
  var s = t._gsap, h = n || Ei(t, !0), u = s.xOrigin || 0, l = s.yOrigin || 0, g = s.xOffset || 0, A = s.yOffset || 0, S = h[0], p = h[1], k = h[2], I = h[3], w = h[4], f = h[5], C = e.split(" "), d = parseFloat(C[0]) || 0, c = parseFloat(C[1]) || 0, J, m, Q, y;
  i ? h !== ye && (m = S * I - p * k) && (Q = d * (I / m) + c * (-k / m) + (k * f - I * w) / m, y = d * (-p / m) + c * (S / m) - (S * f - p * w) / m, d = Q, c = y) : (J = en(t), d = J.x + (~C[0].indexOf("%") ? d / 100 * J.width : d), c = J.y + (~(C[1] || C[0]).indexOf("%") ? c / 100 * J.height : c)), r || r !== !1 && s.smooth ? (w = d - u, f = c - l, s.xOffset = g + (w * S + f * k) - w, s.yOffset = A + (w * p + f * I) - f) : s.xOffset = s.yOffset = 0, s.xOrigin = d, s.yOrigin = c, s.smooth = !!r, s.origin = e, s.originIsAbsolute = !!i, t.style[ot] = "0px 0px", a && (Tt(a, s, "xOrigin", u, d), Tt(a, s, "yOrigin", l, c), Tt(a, s, "xOffset", g, s.xOffset), Tt(a, s, "yOffset", A, s.yOffset)), t.setAttribute("data-svg-origin", d + " " + c);
}, Qe = function(t, e) {
  var i = t._gsap || new Nr(t);
  if ("x" in i && !e && !i.uncache)
    return i;
  var r = t.style, n = i.scaleX < 0, a = "px", s = "deg", h = getComputedStyle(t), u = kt(t, ot) || "0", l, g, A, S, p, k, I, w, f, C, d, c, J, m, Q, y, B, x, v, O, P, H, U, F, V, et, wt, lt, tt, ft, it, pt;
  return l = g = A = k = I = w = f = C = d = 0, S = p = 1, i.svg = !!(t.getCTM && rn(t)), h.translate && ((h.translate !== "none" || h.scale !== "none" || h.rotate !== "none") && (r[G] = (h.translate !== "none" ? "translate3d(" + (h.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + (h.rotate !== "none" ? "rotate(" + h.rotate + ") " : "") + (h.scale !== "none" ? "scale(" + h.scale.split(" ").join(",") + ") " : "") + (h[G] !== "none" ? h[G] : "")), r.scale = r.rotate = r.translate = "none"), m = Ei(t, i.svg), i.svg && (i.uncache ? (V = t.getBBox(), u = i.xOrigin - V.x + "px " + (i.yOrigin - V.y) + "px", F = "") : F = !e && t.getAttribute("data-svg-origin"), pi(t, F || u, !!F || i.originIsAbsolute, i.smooth !== !1, m)), c = i.xOrigin || 0, J = i.yOrigin || 0, m !== ye && (x = m[0], v = m[1], O = m[2], P = m[3], l = H = m[4], g = U = m[5], m.length === 6 ? (S = Math.sqrt(x * x + v * v), p = Math.sqrt(P * P + O * O), k = x || v ? te(v, x) * bt : 0, f = O || P ? te(O, P) * bt + k : 0, f && (p *= Math.abs(Math.cos(f * ae))), i.svg && (l -= c - (c * x + J * O), g -= J - (c * v + J * P))) : (pt = m[6], ft = m[7], wt = m[8], lt = m[9], tt = m[10], it = m[11], l = m[12], g = m[13], A = m[14], Q = te(pt, tt), I = Q * bt, Q && (y = Math.cos(-Q), B = Math.sin(-Q), F = H * y + wt * B, V = U * y + lt * B, et = pt * y + tt * B, wt = H * -B + wt * y, lt = U * -B + lt * y, tt = pt * -B + tt * y, it = ft * -B + it * y, H = F, U = V, pt = et), Q = te(-O, tt), w = Q * bt, Q && (y = Math.cos(-Q), B = Math.sin(-Q), F = x * y - wt * B, V = v * y - lt * B, et = O * y - tt * B, it = P * B + it * y, x = F, v = V, O = et), Q = te(v, x), k = Q * bt, Q && (y = Math.cos(Q), B = Math.sin(Q), F = x * y + v * B, V = H * y + U * B, v = v * y - x * B, U = U * y - H * B, x = F, H = V), I && Math.abs(I) + Math.abs(k) > 359.9 && (I = k = 0, w = 180 - w), S = z(Math.sqrt(x * x + v * v + O * O)), p = z(Math.sqrt(U * U + pt * pt)), Q = te(H, U), f = Math.abs(Q) > 2e-4 ? Q * bt : 0, d = it ? 1 / (it < 0 ? -it : it) : 0), i.svg && (F = t.getAttribute("transform"), i.forceCSS = t.setAttribute("transform", "") || !an(kt(t, G)), F && t.setAttribute("transform", F))), Math.abs(f) > 90 && Math.abs(f) < 270 && (n ? (S *= -1, f += k <= 0 ? 180 : -180, k += k <= 0 ? 180 : -180) : (p *= -1, f += f <= 0 ? 180 : -180)), e = e || i.uncache, i.x = l - ((i.xPercent = l && (!e && i.xPercent || (Math.round(t.offsetWidth / 2) === Math.round(-l) ? -50 : 0))) ? t.offsetWidth * i.xPercent / 100 : 0) + a, i.y = g - ((i.yPercent = g && (!e && i.yPercent || (Math.round(t.offsetHeight / 2) === Math.round(-g) ? -50 : 0))) ? t.offsetHeight * i.yPercent / 100 : 0) + a, i.z = A + a, i.scaleX = z(S), i.scaleY = z(p), i.rotation = z(k) + s, i.rotationX = z(I) + s, i.rotationY = z(w) + s, i.skewX = f + s, i.skewY = C + s, i.transformPerspective = d + a, (i.zOrigin = parseFloat(u.split(" ")[2]) || !e && i.zOrigin || 0) && (r[ot] = Ne(u)), i.xOffset = i.yOffset = 0, i.force3D = ct.force3D, i.renderTransform = i.svg ? Pa : tn ? sn : Ua, i.uncache = 0, i;
}, Ne = function(t) {
...
}, qt = "0deg", ue = "0px", Yt = ") ", sn = function(t, e) {
  ...
  return s && (g = n.split("_")[1], g === "short" && (u %= a, u !== u % (a / 2) && (u += u < 0 ? a : -a)), g === "cw" && u < 0 ? u = (u + a * tr) % a - ~~(u / a) * a : g === "ccw" && u > 0 && (u = (u - a * tr) % a - ~~(u / a) * a)), t._pt = A = new st(t._pt, e, i, r, u, Sa), A.e = l, A.u = "deg", t._props.push(i), A;
}, or = function(t, e) {
  for (var i in e)
    t[i] = e[i];
  return t;
}, Ha = function(t, e, i) {
  var r = or({}, i._gsap), n = "perspective,force3D,transformOrigin,svgOrigin", a = i.style, s, h, u, l, g, A, S, p;
  ...
  for (h in Ut)
    u = r[h], l = s[h], u !== l && n.indexOf(h) < 0 && (S = _(u), p = _(l), g = S !== p ? Nt(i, h, u, p) : parseFloat(u), A = parseFloat(l), t._pt = new st(t._pt, s, h, g, A - g, ci), t._pt.u = p || 0, t._props.push(h));
  or(s, r);
};
at("padding,margin,Width,Radius", function(o, t) {
...
var on = {
  ...
  init: function(t, e, i, r, n) {
    ...
    Fi || di(), this.styles = this.styles || $r(t), Q = this.styles.props, this.tween = i;
    for (k in e)
      if (k !== "autoRound" && (l = e[k], !(ut[k] && Gr(k, e, i, r, t, n)))) {
        if (S = typeof l, p = We[k], S === "function" && (l = l.call(i, r, t, n), S = typeof l), S === "string" && ~l.indexOf("random(") && (l = Je(l)), p)
          ...
          if (h && k in h ? (u = typeof h[k] == "function" ? h[k].call(i, r, t, n) : h[k], j(u) && ~u.indexOf("random(") && (u = Je(u)), _(u + "") || u === "auto" || (u += ct.units[k] || _(Ot(t, k)) || ""), (u + "").charAt(1) === "=" && (u = Ot(t, k))) : u = Ot(t, k), A = parseFloat(u), f = S === "string" && l.charAt(1) === "=" && l.substr(0, 2), f && (l = l.substr(2)), g = parseFloat(l), k in Bt && (k === "autoAlpha" && (A === 1 && Ot(t, "visibility") === "hidden" && g && (A = 0), Q.push("visibility", 0, s.visibility), Tt(this, s, "visibility", A ? "inherit" : "hidden", g ? "inherit" : "hidden", !g)), k !== "scale" && k !== "transform" && (k = Bt[k], ~k.indexOf(",") && (k = k.split(",")[0]))), C = k in Ut, C) {
            if (this.styles.save(k), y = l, S === "string" && l.substring(0, 6) === "var(--") {
              if (l = kt(t, l.substring(4, l.indexOf(")"))), l.substring(0, 5) === "calc(") {
                var B = t.style.perspective;
                t.style.perspective = l, l = kt(t, "perspective"), B ? t.style.perspective = B : Wt(t, "perspective");
              }
              g = parseFloat(l);
            }
            if (d || (c = t._gsap, c.renderTransform && !e.parseTransform || Qe(t, e.parseTransform), J = e.smoothOrigin !== !1 && c.smooth, d = this._pt = new st(this._pt, s, G, 0, 1, c.renderTransform, c, 0, -1), d.dep = 1), k === "scale")
              this._pt = new st(this._pt, c, "scaleY", c.scaleY, (f ? re(c.scaleY, f + g) : g) - c.scaleY || 0, ci), this._pt.u = 0, a.push("scaleY", k), k += "X";
            else if (k === "transformOrigin") {
              Q.push(ot, 0, s[ot]), l = Oa(l), c.svg ? pi(t, l, 0, J, 0, this) : (w = parseFloat(l.split(" ")[2]) || 0, w !== c.zOrigin && Tt(this, c, "zOrigin", c.zOrigin, w), Tt(this, s, k, Ne(u), Ne(l)));
              continue;
            } else if (k === "svgOrigin") {
              pi(t, l, 1, J, 0, this);
              continue;
            } else if (k in nn) {
              Fa(this, c, k, A, f ? re(A, f + l) : l);
              continue;
          ...
          if (C || (g || g === 0) && (A || A === 0) && !ca.test(l) && k in s)
            I = (u + "").substr((A + "").length), g || (g = 0), w = _(l) || (k in ct.units ? ct.units[k] : I), I !== w && (A = Nt(t, k, u, w)), this._pt = new st(this._pt, C ? c : s, k, A, (f ? re(A, f + g) : g) - A, !C && (w === "px" || k === "zIndex") && e.autoRound !== !1 ? Ia : ci), this._pt.u = w || 0, C && y !== l ? (this._pt.b = u, this._pt.e = y, this._pt.r = pa) : I !== w && w !== "%" && (this._pt.b = u, this._pt.r = da);
          else if (k in s)
            xa.call(this, t, k, u, f ? f + l : l);
          else if (k in t)
  ...
  getSetter: function(t, e, i) {
    var r = Bt[e];
    return r && r.indexOf(",") < 0 && (e = r), e in Ut && e !== ot && (t._gsap.x || Ot(t, "x")) ? i && $i === i ? e === "scale" ? ma : wa : ($i = i || {}) && (e === "scale" ? ya : Qa) : t.style && !Ji(t.style[e]) ? Ca : ~e.indexOf("-") ? Ja : Ui(t, e);
  },
  core: {
    _removeProperty: Wt,
    _getMatrix: Ei
...
ht.utils.checkPrefix = fe;
ht.core.getStyleSaver = $r;
(function(o, t, e, i) {
  var r = at(o + "," + t + "," + e, function(n) {
    Ut[n] = 1;
  });
  at(t, function(n) {
    ct.units[n] = "deg", nn[n] = 1;
  }), Bt[r[13]] = o + "," + t, at(i, function(n) {
    var a = n.split(":");
    Bt[a[1]] = r[a[0]];
  });
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");
at("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function(o) {
  ct.units[o] = "px";
});
ht.registerPlugin(on);
var Ri = ht.registerPlugin(on) || ht;
Ri.core.Tween;
function Ta(o) {
  var t = this;
...
function Ra(o) {
  ...
  i.addEventListener("mousewheel", h), i.addEventListener("pointerdown", h), i.addEventListener("pointermove", h), i.addEventListener("pointerup", h), i.addEventListener("pointerleave", h);
}
class La {
  constructor(t) {
    var e = this;
    ...
    t.userBounds && this.userBounds.set(t.userBounds), t.cameraBounds && this.cameraBounds.set(t.cameraBounds), t.maxWidth && (this.maxWidth = t.maxWidth), t.maxHeight && (this.maxHeight = t.maxHeight), this.camera = new Ta({ stage: this });
    ...
    this.root = new hn({
      ...
      parent: !1,
      changed: !0
    }), this.mouse = r.mouseEnabled !== !1 ? new Ra({ target: a, root: this.root }) : !1;
    var g = {};
    function A() {
...
var qa = /* @__PURE__ */ (function(o) {
  ...
  function h(l, g, A, c, p) {
    ...
    var F = y[0].blocks[0].style, V = 0, et = 0, wt = 0;
    function lt(Y) {
      return newVal = parseInt(Y), +newVal === newVal && !(newVal % 1) ? newVal : 0;
    }
    function tt(Y) {
      e += lt(Y.marginTop) + lt(Y.marginBottom) + lt(Y.paddingTop) + lt(Y.paddingBottom);
    }
    for (var H = 0; H < y.length; H++) {
      for (var ft = y[H], it = !1, pt = 0, Vt = 0; Vt < ft.blocks.length; Vt++)
        ft.blocks[Vt].type === "text" && pt++;
      for (var L = 0; L < ft.blocks.length; L++) {
        var q = ft.blocks[L];
        if (p)
          ...
          switch (q.type) {
            case "style":
              k(q.style), F = q.style, tt(q.style), (q.style.display !== "inline" || pt < 2) && (et += q.style.marginTop + wt), wt = q.style.marginBottom;
              break;
            case "text":
              if (it || (et += ft.lineHeight * m, F.textAlign == "center" && (V = (J - ft.width) * 0.5, C.save()), it = !0), C.fillText(q.text.join(" "), V, et), F.textDecoration == "underline") {
...
function Ya() {
  ...
  if (this.rotation !== 0 && (this._tx = this.__x + this.__width * this.transformCenterX, this._ty = this.__y + this.__height * this.transformCenterY, o.translate(this._tx, this._ty), o.rotate(this.rotation * Gi), o.translate(-this._tx, -this._ty)), this.clip && (o.beginPath(), o.rect(this.__x + this.clip.x, this.__y + this.clip.y, this.clip.width, this.clip.height), o.clip()), this._alpha < 1 && (i = !0, o.globalAlpha = this._alpha), this.fillStyle && (o.fillStyle = this.fillStyle, this.repeatX === !0 ? o.fillRect(0, this.__y, this.root.width, this.__height) : this.borderRadius !== !1 ? cn(o, this.__x, this.__y, this.__width, this.__height, this.borderRadius, this.fillStyle) : o.fillRect(this.__x, this.__y, this.__width, this.__height)), this.bitmapData !== !1 ? Wa.call(this) : this.html !== !1 ? Va.call(this) : this.image !== !1 && Na.call(this), this.div !== !1) {
    var u = {
      position: "fixed",
...
function Xa() {
  mt.addChild(Za(mt)).on(Ii.UPDATED, (t) => {
    t.target.y += 0.5;
  });
}
function lr(o) {
...
function $a(o) {
  mt.camera.moveToElement(o.target, 50, 3, ga.easeInOut), ln.forEach((t) => t.selected = !1), o.target.selected = !0;
}
function ts() {
    ...
    mt.addChild(
      new Ge({
        ...
        beforeUpdate: function() {
          this.setProperty({ z: mt.camera.z + this.offSetZ });
        }
        // onResize: function () {
...
function is(o) {
  return ja(), Xa(), ts(), es(), o.appendChild(mt.cvs), mt;
}
function rs() {
  mt.stopRender(), mt.cvs.remove();
}
const ns = (o) => {
  const t = Pe(null), { width: e, height: i } = kn({ ref: t }), [r, n] = fr(null);
  return Fe(() => {
    r && r.setSize(e, i);
  }, [e, i]), Fe(() => {
    if (t.current) {
  ...
  }, []), /* @__PURE__ */ fn("div", { ref: t, style: { width: 500, height: 500 }, ...o });
}, hs = ns;
export {
  hs as LanternsReact
};
